...
class DetailsScreenPlaceTrip extends StatefulWidget {
  const DetailsScreenPlaceTrip({super.key,required this.title,
    required this.name,
      ...
      return Scaffold(
        body: Conditional.single(
          ...
          widgetBuilder: (BuildContext context) =>  ScaffoldLayoutBuilder(
            backgroundColorAppBar: const ColorBuilder(Colors.transparent, Color(0xff003441)),
            ...
            child: SingleChildScrollView(
              child: Stack(
                children: [
                  CachedNetworkImage(
                    imageUrl: widget.image.isNotEmpty  ? widget.image : 'https://static.vecteezy.com/system/resources/previews/004/141/669/original/no-photo-or-blank-image-icon-loading-images-or-missing-image-mark-image-not-available-or-image-coming-soon-sign-simple-nature-silhouette-in-frame-isolated-illustration-vector.jpg',
